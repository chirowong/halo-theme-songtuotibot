<!--[if lt IE 9]>
    <script src="${theme_base!}/js/css3-mediaqueries.min.js"></script>
    <script src="${theme_base!}/js/html5.min.js"></script>
    <script src="${theme_base!}/js/tiny-slider.helper.ie8.min.js"></script>
<![endif]-->
...
<link rel="stylesheet" type="text/css" href="${theme_base!}/assets/css/base.css"  />